package io.github.ademarizu.api.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("JHipsterTestApi");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("JHipsterTestApi");
        ...
        config.getMapConfigs().put("io.github.ademarizu.api.domain.*", initializeDomainMapConfig(jHipsterProperties));
